  ...
  <div class="container">
    <section class="section">
      ...
      <div style="margin-top: 2rem;">
        <NuxtLink to="/voice" class="cta-btn">お客様の声を読む</NuxtLink>
      </div>
    </section>
  </div>
  ...
  <div class="container">
    <section class="section">
      ...
      <p class="story-para">
        ...
        私自身がその場所にいました。<br>そして、その場所から抜け出す道を、自分で歩いてきました。
      </p>
      <p class="story-para">
      ...
      <div style="margin-top: 2rem;">
        <NuxtLink to="/story" class="cta-btn">私の原体験を読む</NuxtLink>
      </div>
    </section>
  </div>
