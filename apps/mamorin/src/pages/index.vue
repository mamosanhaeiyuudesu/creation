        ...
        <div class="mm-strength-list">
          <div class="mm-strength-item">
            ...
            <p class="mm-strength-body">
              私自身、人の輪に入れない、目上の人間に反発する、女性とうまく話せない、心から休めない——そんな経験を長く抱えてきました。<br>
          ...
          <div class="mm-strength-item">
           ...
           <div class="mm-strength-item">
            ...
            <p class="mm-strength-body">
              ...
              普通のカウンセラーには理解してもらえないような、左脳よりな話、理屈っぽい話も、安心して話せます。<br>
              また、AIを駆使しながら思考を構造化・見える化することで、感情や経験のパターンを客観的に理解することができます。<br>
            </p>
          </div>
        </div>
      </div>
      ...
      <div class="mm-wrap">
        ...
        <div class="mm-profile-inner">
          ...
          <p class="mm-profile-bio">
            ...
            IT企業に務めながら、妻と3人の子育てをしている父親でもある。<br>
          </p>
        </div>
      </div>
    </section>
...
const faqs = [
  {
    q: '通常のカウンセリングと何が違いますか？',
    a: [
      '基本的には変わりませんが、対話の文字起こしと構造化を通じて、まず知的に理解するところから始める点が特徴です。',
      '理屈っぽい方や考えすぎてしまうタイプの方でも、無理なく自分のペースでご自身の本音や感情との接点に近づいていけます。',
    ],
  },
  {
  ...
  },
  {
    q: 'オンラインでも大丈夫ですか？',
    a: [
      'はい、すべてオンライン（ビデオ通話）での対応です。',
      '「自分の空間にいながら話せる」ので、話しやすいと感じる方も多いです。',
    ],
  },
  {
    q: '初回の無料相談では何をしますか？',
