    ...
    <section id="about" class="ac-about">
      <div class="ac-wrap">
        ...
        <div class="about-grid">
          ...
          <div class="about-card">
            ...
            <div class="about-card-body">
              ...
              <p>自分のプロトタイプから生まれたプロダクトは、一部上場企業を中心に500社以上に導入。テレビをはじめとするマスコミ媒体でも繰り返し取り上げられ、幾多の新製品を生み出す原動力にもなってきました。</p>
            </div>
          </div>
          ...
          <div class="about-card">
            ...
            <div class="about-card-body">
              ...
              <p>自身の長年の経験に加えて、他社事例を素早く参照・応用しながら具体的なプロトタイプを作り、チームや顧客の意思決定を加速させるスタイルが自分の強みです。</p>
            </div>
          </div>
          ...
          <div class="about-card">
            <div class="about-card-header">
              ...
              <h3 class="about-card-title">一気通貫の開発</h3>
            </div>
            <div class="about-card-body">
        ...
        <div class="about-profile">
          桐蔭学園理数科卒、慶応義塾大学情報工学科卒業。趣味は子どもと始めた剣道、ベランダ農業。他に副業としてカウンセリングもやっています。
        </div>
      </div>
    </section>
