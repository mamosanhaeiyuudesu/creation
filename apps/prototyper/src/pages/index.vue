  ...
  <div class="ac-page">
          ...
          <div class="hero-text">
            ...
            <div class="hero-sub">
              <p>「こういうのがあったらなあ...」<br />
                ——この段階でお話を聞かせてください。</p>
              <p>
                ものづくりの主役は、つくる人ではなく、毎日その現場にいる<strong>ユーザー</strong>です。<br />
                私の仕事は、ユーザーの中にすでにある答えを、形にして一緒に育てていくことです。
              </p>
              <p>
                ITのことは分からなくて大丈夫です。<br />
                専門用語は使いません。
              </p>
            </div>
    ...
    <section id="process" class="ac-process">
      <div class="ac-wrap">
        ...
        <p class="section-body">
          あなたが「実現したいこと」をじっくり伺って、触れる形にして、一緒に育てていきます。企画書を書いてから作るのではなく、伺った話をそのまま動くものにして、それを叩き台に一緒に考えていきます。
        </p>
        ...
        <ol class="process-list">
          <li class="process-item">
            ...
            <div class="process-body">
              ...
              相談することと、お願いすることは別です。まずは「こんなことできますか」を聞かせてください。そのまま、お困りごとや現場のやり方、「本当はこうしたい」までじっくり伺うこともできます。何を作るかより先に、大事にしているのは「なぜそれを実現したいのか」。そこが分かると、作るべきものは自然に決まります。現場ごとの例外や、長年のやり方のクセ。既製のサービスが拾いきれないのは、たいていそこです。専門用語は使いませんので、普段の言葉のままお話しください。要件が決まっていなくて大丈夫です。むしろその段階から声をかけてください。この段階で終わっても、まったく構いません。
            </div>
          </li>
          <li class="process-item">
            ...
            <div class="process-body">
              ...
              伺った話を、その場で、あるいは1〜2日で「動くもの」にしてお見せします。文章で仕様を確認し合うより、触ってもらったほうが早いからです。待たされている間に熱が冷めてしまわないよう、とにかく早くお見せすることを大事にしています。AIに任せられるところは任せ、そのぶんの時間をあなたの話を聞くことに使っています。画面のデザインから、裏側の仕組み、データの保管、外部サービスとの連携まで、すべてひとりで担当します。窓口がひとつで済むので、話が伝わらないもどかしさがありません。データの集計・グラフ化や、AIを使った機能も、この中で対応します。
            </div>
          </li>
          <li class="process-item">
            ...
            <div class="process-body">
              ...
              「ここは違う」「これも欲しい」を受けて、何度でも作り直します。壊される前提で作っているので、遠慮はいりません。一番良いものが生まれるのは、たいていこのやりとりの途中です。私が正解を出すのではなく、あなたの中にある答えが形になっていく時間だと思っています。
            </div>
          </li>
          <li class="process-item">
            ...
            <div class="process-body">
              ...
              形になってきたら、実際に使う方に、普段の仕事の中で触って確かめていただきます。テスト専任の担当者を立てて机の上で確認するのではなく、現場で使う方ご自身に試していただく進め方です。お手間はおかけしますが、そのぶん人件費がかからないので、費用を抑えられます。それに、触っているうちに「ここは押しにくい」「この順番だと使いづらい」が自然と出てきます。机の上の確認では出てこないものばかりです。かしこまった報告書は要りません。気づいたその場で、そのままお知らせください。すぐ直します。
            </div>
          </li>
          <li class="process-item">
      ...
      <div class="ac-wrap">
        ...
        <div class="portfolio-card">
          <div class="portfolio-card-header">
            ...
            <h3 class="portfolio-card-title">宮古島市議会 議事録の可視化</h3>
            <dl class="work-ba">
              <div>
                <dt>どなたの</dt>
                <dd>市政に関心のある市民、そして自治体の方</dd>
              </div>
              <div>
                <dt>困っていたこと</dt>
                <dd>議事録は公開されているのに、PDFのままで読みにくく、誰も活用できていなかった</dd>
              </div>
              <div>
                <dt>したこと</dt>
        ...
        <div class="portfolio-card">
          <div class="portfolio-card-header">
            ...
            <dl class="work-ba">
              <div>
                <dt>どなたの</dt>
                <dd>和歌山県の町で活動する、農家のみなさん</dd>
              </div>
              <div>
                <dt>困っていたこと</dt>
                <dd>会議の音声が録りっぱなしで、記録として眠るだけになっていた</dd>
              </div>
              <div>
                <dt>したこと</dt>
    ...
    <section id="about" class="ac-about">
      <div class="ac-wrap">
        ...
        <!-- 原点 -->
        <div class="origin">
          <span class="origin-label">原点</span>
          <p class="origin-lead">このやり方の原点は、たった一言でした。</p>

          <blockquote class="origin-quote">
            <p>「Excelの表は見にくいから、ネットワーク図にしてはどうか」</p>
            <cite>会社員時代、社内でツールを使ってくれていた一人の言葉</cite>
          </blockquote>
          ...
          <p class="origin-close">
            思いついたのは、私ではありません。<strong>毎日それを使っている人が、すでに答えを持っていた。</strong><br />
            それ以来、「なぜそれを実現したいのか」というお客さん自身の声を何より大切に伺い、
            それを見える形に変えることを、仕事の出発点にしています。
          </p>
        </div>
        ...
        <div class="about-profile">
          2002年：桐蔭学園理数科卒<br>
          2006年：慶応義塾大学情報工学科卒業。<br>
          趣味は格闘技や野球観戦、子どもと始めた剣道、ベランダ農業など。<br>
          他に心理カウンセラーとして活動中。
        </div>
      </div>
    </section>
    ...
    <footer class="ac-footer">
      <div class="ac-footer-inner">
        ...
        <a href="https://prototype.insightlens.jp/miyako" class="ac-footer-link">実績: 宮古島市議会 議事録の可視化 →</a>
      </div>
    </footer>
...
useHead({
  title: 'prototyper | 答えは、いつもあなたの中にある。',
  meta: [
    { name: 'description', content: 'ものづくりの主役は、つくる人ではなくあなた自身。実現したいことをじっくり伺い、触れるプロトタイプにして一緒に育てます。ITが苦手な方でも大丈夫。規模に応じて、運用まで担当することも、設計図にして専門チームへ渡すこともできます。' },
