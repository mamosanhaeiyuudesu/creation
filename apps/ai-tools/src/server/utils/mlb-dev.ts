...
const YEARLY_BATTER: Record<string, Array<Omit<BatterStats, 'playerId' | 'date'>>> = {
  ...
  '673548': [
    { season: 2022, avg: 0.262, obp: 0.336, slg: 0.463, ops: 0.799, bbPct: 9.8,  kPct: 22.1, hr: 14, rbi: 55, hits: 101, runs: 50, stolenBases: 4 },
    { season: 2023, avg: 0.285, obp: 0.358, slg: 0.497, ops: 0.855, bbPct: 10.5, kPct: 19.3, hr: 20, rbi: 75, hits: 132, runs: 68, stolenBases: 6 },
    { season: 2024, avg: 0.278, obp: 0.351, slg: 0.490, ops: 0.841, bbPct: 10.1, kPct: 20.2, hr: 22, rbi: 82, hits: 128, runs: 72, stolenBases: 5 },
    { season: 2025, avg: 0.292, obp: 0.366, slg: 0.502, ops: 0.868, bbPct: 10.8, kPct: 18.9, hr: 25, rbi: 90, hits: 140, runs: 78, stolenBases: 8 },
  ],
  '666971': [
    { season: 2022, avg: 0.228, obp: 0.321, slg: 0.407, ops: 0.728, bbPct: 11.2, kPct: 23.4, hr: 8,  rbi: 40, hits: 88,  runs: 52, stolenBases: 10 },
    { season: 2023, avg: 0.259, obp: 0.345, slg: 0.437, ops: 0.782, bbPct: 11.8, kPct: 21.8, hr: 14, rbi: 58, hits: 110, runs: 65, stolenBases: 15 },
    { season: 2024, avg: 0.247, obp: 0.338, slg: 0.424, ops: 0.762, bbPct: 11.5, kPct: 22.3, hr: 12, rbi: 52, hits: 102, runs: 61, stolenBases: 18 },
    { season: 2025, avg: 0.262, obp: 0.352, slg: 0.439, ops: 0.791, bbPct: 12.1, kPct: 20.9, hr: 15, rbi: 62, hits: 115, runs: 70, stolenBases: 20 },
  ],
  '660271': [
    { season: 2024, avg: 0.310, obp: 0.390, slg: 0.621, ops: 1.011, bbPct: 13.8, kPct: 23.1, hr: 54, rbi: 130, hits: 174, runs: 134, stolenBases: 59 },
    { season: 2025, avg: 0.295, obp: 0.382, slg: 0.589, ops: 0.971, bbPct: 14.1, kPct: 22.5, hr: 48, rbi: 118, hits: 161, runs: 122, stolenBases: 42 },
  ],
}
...
const YEARLY_PITCHER: Record<string, Array<Omit<PitcherStats, 'playerId' | 'date'>>> = {
  ...
  '660271': [
    { season: 2024, era: 1.98, whip: 0.88, kPct: 34.8, bbPct: 6.2, wins: 10, losses: 5,  strikeouts: 144, inningsPitched: 132.0, saves: 0, holds: 0 },
    { season: 2025, era: 2.15, whip: 0.93, kPct: 35.2, bbPct: 6.6, wins: 11, losses: 4,  strikeouts: 138, inningsPitched: 128.2, saves: 0, holds: 0 },
  ],
  '808967': [
  ...
  '506433': [
    { season: 2020, era: 2.01, whip: 0.96, kPct: 32.1, bbPct: 7.8, wins: 8,  losses: 3,  strikeouts: 93,  inningsPitched: 76.0,  saves: 0, holds: 0 },
    { season: 2021, era: 4.22, whip: 1.31, kPct: 23.8, bbPct: 8.9, wins: 8,  losses: 11, strikeouts: 144, inningsPitched: 148.2, saves: 0, holds: 0 },
    { season: 2022, era: 3.10, whip: 1.09, kPct: 26.4, bbPct: 7.2, wins: 16, losses: 8,  strikeouts: 194, inningsPitched: 166.0, saves: 0, holds: 0 },
    { season: 2023, era: 4.56, whip: 1.38, kPct: 22.1, bbPct: 8.5, wins: 12, losses: 11, strikeouts: 152, inningsPitched: 145.0, saves: 0, holds: 0 },
    { season: 2024, era: 3.45, whip: 1.15, kPct: 25.8, bbPct: 7.1, wins: 13, losses: 9,  strikeouts: 168, inningsPitched: 158.1, saves: 0, holds: 0 },
    { season: 2025, era: 3.28, whip: 1.11, kPct: 26.8, bbPct: 6.8, wins: 14, losses: 8,  strikeouts: 178, inningsPitched: 162.0, saves: 0, holds: 0 },
  ],
  '579328': [
    { season: 2022, era: 4.12, whip: 1.28, kPct: 21.8, bbPct: 9.2, wins: 10, losses: 10, strikeouts: 138, inningsPitched: 148.0, saves: 0, holds: 0 },
    { season: 2023, era: 3.86, whip: 1.22, kPct: 22.8, bbPct: 8.8, wins: 11, losses: 10, strikeouts: 148, inningsPitched: 154.2, saves: 0, holds: 0 },
...
function makeLeagueBlock(
  ...
  pitcherLeaders: { era: number; whip: number; kPct: number; bbPct: number; wins: number; losses: number; strikeouts: number; inningsPitched: number; saves: number; holds: number },
...
export function getDevLeagueStats(): AllLeagueStats {
  return {
    AL: makeLeagueBlock(
      ...
      { era: 1.42, whip: 0.82, kPct: 38.5, bbPct: 3.8, wins: 5, losses: 1, strikeouts: 52, inningsPitched: 40.0, saves: 10, holds: 9 },
    ...
    NL: makeLeagueBlock(
      ...
      { era: 1.38, whip: 0.80, kPct: 40.2, bbPct: 3.5, wins: 5, losses: 1, strikeouts: 55, inningsPitched: 42.0, saves: 9, holds: 8 },
