            ...
            <tr class="border-b-2 border-slate-200">
              ...
              <th class="text-center py-2 px-3 text-xs font-medium text-slate-400 w-24 sticky top-0 z-20 bg-white">
                <span class="inline-flex items-center gap-1">
                  {{ league }}リーグ
                  <a
                    :href="league === 'AL' ? 'https://baseball.yahoo.co.jp/mlb/stats/pitcher?gameKindId=1001' : 'https://baseball.yahoo.co.jp/mlb/stats/pitcher?gameKindId=1002'"
                    target="_blank"
            ...
            <tr class="border-b-2 border-slate-200">
              ...
              <th class="text-center py-2 px-3 text-xs font-medium text-slate-400 w-24 sticky top-0 z-20 bg-white">
                <span class="inline-flex items-center gap-1">
                  {{ league }}リーグ
                  <a
                    :href="league === 'AL' ? 'https://baseball.yahoo.co.jp/mlb/stats/batter?gameKindId=1001' : 'https://baseball.yahoo.co.jp/mlb/stats/batter?gameKindId=1002'"
                    target="_blank"
                    rel="noopener noreferrer"
                    class="text-slate-300 hover:text-slate-500 transition-colors"
                    title="リーグ打者成績を見る"
