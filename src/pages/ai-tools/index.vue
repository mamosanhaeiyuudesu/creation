...
const tools = [
  { path: '/ai-tools/snapreader', icon: '📸', name: 'SnapReader', desc: '画像を送って、数秒で要約' },
  { path: '/ai-tools/whisper', icon: '🎙️', name: 'Whisper', desc: '音声を文字に自動変換' },
  { path: '/ai-tools/hagemashi', icon: '💪', name: 'はげまし', desc: '話して、AIに励ましてもらおう' },
  { path: '/ai-tools/miyako', icon: '🏝️', name: '宮古島市議会バズワード', desc: '会期別キーワード特徴度ヒートマップ' },
  { path: '/ai-tools/task', icon: '📋', name: 'タスクくん', desc: 'Trello の DOING / TODO / DONE をまとめて確認' },
]
</script>
